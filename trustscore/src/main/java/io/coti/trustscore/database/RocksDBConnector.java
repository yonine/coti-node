...
//  Temporary section begin
    ...
    private void databaseAdHocRefactor() {
        ...
        while (iterator.isValid()) {
            ...
            Hash bucketDocumentScoreNew = getBucketHashByUserHashAndScoreType(userTrustScoreData.getHash(), EventType.DOCUMENT_SCORE.value);
            ...
            Hash bucketTransactionsNew = getBucketHashByUserHashAndScoreType(userTrustScoreData.getHash(), EventType.TRANSACTION.value);
