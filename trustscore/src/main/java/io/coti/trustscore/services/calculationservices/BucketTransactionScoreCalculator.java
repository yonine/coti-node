...
public class BucketTransactionScoreCalculator extends BucketScoresCalculator<BucketTransactionEventData> {

    private static final int MONTH_LENGTH = 30;
    private TransactionUserParameters userParameters;


    public BucketTransactionScoreCalculator(BucketTransactionEventData bucketData) {
        super(bucketData);
