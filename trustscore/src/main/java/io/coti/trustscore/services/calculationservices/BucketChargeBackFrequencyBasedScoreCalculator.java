...
@Slf4j
public class BucketChargeBackFrequencyBasedScoreCalculator extends BucketScoresCalculator<BucketChargeBackFrequencyBasedEventData> {
    private static final int MONTH_LENGTH = 30;
    private ChargeBackUserParameters userParameters;

    public BucketChargeBackFrequencyBasedScoreCalculator(BucketChargeBackFrequencyBasedEventData bucketChargeBackFrequencyBasedEventData) {
        super(bucketChargeBackFrequencyBasedEventData);
        userParameters = (ChargeBackUserParameters) BucketChargeBackFrequencyBasedScoreService.userParameters(
                FinalEventType.CHARGEBACK, bucketChargeBackFrequencyBasedEventData.getUserType());
    }
